...
INSERT INTO `t_mp_log` VALUES ('205', '唐亚峰', '角色管理', '<font color=\"red\">执行方法异常:-->添加角色</font>', '0', '0:0:0:0:0:0:0:1', '<font color=\"red\">执行方法异常:-->java.lang.RuntimeException: org.hibernate.PropertyValueException: not-null property references a null or transient value: com.battcn.platform.entity.RoleEntity.date</font>', '2016-01-19 17:54:42');
