...
<body>
	<form action="${proClassLower}/${r"${msg }"}.do" name="Form" id="Form" method="post">
		<input type="hidden" name="${proClassUpper}_ID" id="${proClassUpper}_ID" value="${r"${pd."}${proClassUpper}_ID${r"}"}"/>
		<div id="zhongxin">
